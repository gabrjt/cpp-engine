...
namespace Engine::Examples::Collision {
    Circle::Circle(const float radius, const raylib::Color color)
            : Radius(radius)
            , Color(color) {}
    ...
    entt::entity Circle::CreatePlayer(entt::registry &registry,
    ...
    entt::entity Circle::CreateAI(entt::registry &registry,
                                  const Circle &circle,
                                  const Position &position,
                                  const Speed &speed,
