...
int main() {
    ...
    SpawnCircleSystem         spawnCircleSystem(64, application.GetWindow(), application.GetRegistry());
    ...
    application.RegisterSystems(windowSystem,
                                createPlayerSystem,
                                playerInputSystem,
                                logPlayerInputSystem,
                                playerMovementInputSystem,
                                aiMovementInputSystem,
                                spawnCircleSystem,
                                movementSystem,
                                outOfBoundsSystem,
                                drawCircleSystem);
